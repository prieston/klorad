...
self.addEventListener("install", (event) => {
  event.waitUntil(
    (async () => {
      ...
      // Subsequent installs park in "waiting" and let the DS
      // `UpdateAvailablePrompt` surface the refresh prompt. The
      // message handler below activates the new worker on the
      // user's signal.
