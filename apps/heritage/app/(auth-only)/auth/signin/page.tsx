    ...
    <div className="flex min-h-screen items-center justify-center bg-bg px-6 text-text-primary">
      <Panel className="w-full max-w-sm rounded-2xl p-6">
        <div className="flex flex-col items-center text-center">
          {/* Klorad mark rather than a per-tenant logo: Framework 6.4
              requires Worlds to be Klorad-branded, and this screen is the
              curator console, not a visitor surface. */}
          <KloradMark className="h-12 w-auto" title="Klorad" />
          <h1 className="mt-4 text-lg font-semibold text-text-primary">
            Heritage
          </h1>
          <p className="mt-1 text-sm text-text-secondary">
            Sign in to manage your collection, its record and its rights
          </p>
        </div>
