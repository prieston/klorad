 ...
 * to those that have Klorad Heritage enabled. The Klorad admin app
 * controls `Organization.apps`; Heritage surfaces only the
 * subset tagged with `"heritage"`. Personal orgs are excluded.
 */
